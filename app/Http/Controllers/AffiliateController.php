...
class AffiliateController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $user = User::create([
            ...
            'edit_paypal_mail_status' => $request->edit_paypal_mail_status ?? 'active',
            'edit_payoneer_mail_status' => $request->edit_payoneer_mail_status ?? 'active',
            'edit_bank_details_status' => $request->edit_bank_details_status ?? 'active',
            'edit_binance_mail_status' => $request->edit_binance_mail_status ?? 'active',
            'edit_other_payment_method_description_status' => $request->edit_other_payment_method_description_status ?? 'active',
